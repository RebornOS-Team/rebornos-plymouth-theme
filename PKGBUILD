...
package() {
  ...
  install -m644 "${srcdir}/bullet.png" "${pkgdir}/usr/share/plymouth/themes/reborn"
  install -m644 "${srcdir}/entry.png" "${pkgdir}/usr/share/plymouth/themes/reborn"
  install -m644 "${srcdir}/logo.png" "${pkgdir}/usr/share/plymouth/themes/reborn"
  install -m644 "${srcdir}/reborn.plymouth" "${pkgdir}/usr/share/plymouth/themes/reborn"
  install -m644 "${srcdir}/script" "${pkgdir}/usr/share/plymouth/themes/reborn"
  install -m644 "${srcdir}/spinner.png" "${pkgdir}/usr/share/plymouth/themes/reborn"
}
